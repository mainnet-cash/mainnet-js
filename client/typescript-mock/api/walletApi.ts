...
let defaultBasePath = 'http://localhost:3000/v0';
...
export class WalletApi {
     ...
     * @param body Request a new new random wallet
     */
    public async createWallet (body: WalletRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WalletResponse;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(body, "WalletRequest")
        };
