...
export class SendApi {
     ...
     */
    public async sendRequest (body: SendRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SendResponse;  }> {
        ...
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling sendRequest.');
        }
