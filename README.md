...
`mainnet` is currently developed and tested node v22, if your node version is very old or very new, you may have issues getting started. Check the nodejs version first.
