/**
 * The ContractSmartbchController file is a very simple one, which does not need to be changed manually,
...
const service = require('../services/ContractSmartbchService');
