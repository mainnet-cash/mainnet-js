...
const smartBchSep20Balance = ({ smartBchSep20BalanceRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      const wallet = await _smartbch.walletFromId(smartBchSep20BalanceRequest.walletId);
...
const smartBchSep20Genesis = ({ smartBchSep20GenesisRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      const wallet = await _smartbch.walletFromId(smartBchSep20GenesisRequest.walletId);
...
const smartBchSep20Mint = ({ smartBchSep20MintRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      const wallet = await _smartbch.walletFromId(smartBchSep20MintRequest.walletId);
...
const smartBchSep20Send = ({ smartBchSep20SendRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      const wallet = await _smartbch.walletFromId(smartBchSep20SendRequest.walletId);
...
const smartBchSep20SendMax = ({ smartBchSep20SendMaxRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      const wallet = await _smartbch.walletFromId(smartBchSep20SendMaxRequest.walletId);
...
const smartBchSep20TokenInfo = ({ smartBchSep20TokenInfoRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      const wallet = await _smartbch.walletFromId(smartBchSep20TokenInfoRequest.walletId);
