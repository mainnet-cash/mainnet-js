...
export class Contract {
  ...
  public getSerializedText(): string {
    return Mainnet.btoa(this.getContractText());
  }
  ...
  public getSerializedAbi() {
    return Mainnet.btoa(JSON.stringify(this.getContractAbi()));
  }
  ...
  public getSerializedParameters() {
    return Mainnet.btoa(JSON.stringify(this.parameters));
  }
  ...
  public static fromId(contractId: string) {
    ...
    const abi = JSON.parse(Mainnet.atob(serializedAbi));
    const script = Mainnet.atob(serializedScript);
    const parameters = JSON.parse(Mainnet.atob(serializedParams));
