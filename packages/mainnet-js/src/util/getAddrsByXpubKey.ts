...
export async function getAddrsByXpubKey(xpub:string, path:string, count:number){
...
export async function derivePublicNodeCashaddr(xpub, index:number, path?:string){
