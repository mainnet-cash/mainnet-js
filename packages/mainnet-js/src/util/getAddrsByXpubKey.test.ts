import { derivePublicNodeCashaddr, getAddrsByXpubKey, getXpubKeyInfo } from "./getAddrsByXpubKey"
    ...
    test("Should decode xpubInfo", async () => {
        ...
        expect(xpubInfo.chain).toBe("3da4bc190a2680111d31fadfdc905f2a7f6ce77c6f109919116f253d43445219")
        expect(xpubInfo.data).toBe("03774c910fcf07fa96886ea794f0d5caed9afe30b44b83f7e213bb92930e7df4bd")
      ...
      test("Should derive cashaddr given xpub and path", async () => {
        ...
        // m/0
        const xpub = "xpub6F2iaK2JUPcgrZ6RTGH6t8VybLPu1XzfrHsDsaKvK6NfULznU6i6aw6ZoefDW2DpNruSLw73RwQg46qvpqB3eryeJJ2tkFCF4Z6gbr8Pjja"
        const vectors = [
                //  M/44'/145'/0'/0/0
