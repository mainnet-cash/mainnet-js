...
export class CashTokens {
  ...
  constructor(wallet: Wallet) {
    ...
    let provider = CashTokens.defaultProvider;
    if (
 ...
 */
export class TestNetSlp extends CashTokens {
  static get walletType() {
 ...
 */
export class RegTestSlp extends CashTokens {
  static get walletType() {
 ...
 */
export class WifSlp extends CashTokens {
  static get walletType() {
    return WifWallet;
  }
}
 ...
 */
export class TestNetWifSlp extends CashTokens {
  static get walletType() {
 ...
 */
export class RegTestWifSlp extends CashTokens {
  static get walletType() {
 ...
 */
export class WatchSlp extends CashTokens {
  static get walletType() {
    return WatchWallet;
  }
}
 ...
 */
export class TestNetWatchSlp extends CashTokens {
  static get walletType() {
 ...
 */
export class RegTestWatchSlp extends CashTokens {
  static get walletType() {
