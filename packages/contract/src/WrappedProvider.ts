...
import { ElectrumNetworkProvider as MainnetElectrumNetworkProvider, Network, TokenI, UtxoI } from "mainnet-js";
...
export default class WrappedProvider extends ElectrumNetworkProvider {
  constructor(public mainnetProvider: MainnetElectrumNetworkProvider) {
    super(mainnetProvider.network === Network.TESTNET ? "chipnet" : mainnetProvider.network as any, mainnetProvider.electrum as any);
