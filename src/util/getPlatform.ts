...
export function getPlatform():Platform{
    ...
    if(("undefined" !== typeof global) && ("[object global]" === toString.call(global) || "[object Object]" === toString.call(global)) ){
        return Platform.node
    }else{
        if(("undefined" !== typeof WorkerGlobalScope) && ("function" === typeof importScripts) && (navigator instanceof WorkerNavigator)){
