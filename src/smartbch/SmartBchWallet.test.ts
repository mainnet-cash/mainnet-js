...
describe(`Test Ethereum functions`, () => {
  test.skip("Filter logs", async () => {
    expect(hexZeroPad("0x8486c538dcbd6a707c5b3f730b6413286fe8c854", 32)).toBe("0x0000000000000000000000008486c538dcbd6a707c5b3f730b6413286fe8c854");
    const filter = {
    ...
    const watchWallet = await SmartBchWallet.watchOnly("0xB55438d2261C9dFA801848c89377D77fa35a1917");
  ...
  test.skip("Query ethernet with class", async () => {
    ...
    const wallet = await RegTestSmartBchWallet.fromPrivateKey("758c7be51a76a9b6bc6b3e1a90e5ff4cc27aa054b77b7acb6f4f08a219c1ce45");
